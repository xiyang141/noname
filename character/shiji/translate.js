...
const translates = {
	...
	muzhen: "睦阵",
	muzhen_backup: "睦阵",
	muzhen_info: "出牌阶段各限一次。①你可以将两张牌交给一名装备区内有牌的其他角色，然后获得其装备区内的一张牌。②你可以将一张装备牌置于其他角色的装备区内，然后获得其一张手牌。③你可以选择任意名其他角色，这些角色手牌数和装备区牌数每有一项与你相同，其摸一张牌，若这些角色均摸了两张牌，你摸选择角色数张牌。",
	sp_huaxin: "手杀华歆",
	hxrenshi: "仁仕",
