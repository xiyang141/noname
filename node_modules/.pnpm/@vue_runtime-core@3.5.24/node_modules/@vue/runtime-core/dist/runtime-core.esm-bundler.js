import { pauseTracking, resetTracking, isRef, toRaw, traverse, shallowRef, readonly, isReactive, ref, isShallow, isReadonly, shallowReadArray, toReadonly, toReactive, shallowReadonly, track, reactive, shallowReactive, trigger, ReactiveEffect, watch as watch$1, customRef, isProxy, EffectScope, proxyRefs, markRaw, computed as computed$1 } from "../../../../../@vue_reactivity@3.5.24/node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js";
import { TrackOpTypes, TriggerOpTypes, effect, effectScope, getCurrentScope, getCurrentWatcher, onScopeDispose, onWatcherCleanup, stop, toRef, toRefs, toValue, triggerRef, unref } from "../../../../../@vue_reactivity@3.5.24/node_modules/@vue/reactivity/dist/reactivity.esm-bundler.js";
import { isString, isFunction, isPromise, isArray, EMPTY_OBJ, NOOP, getGlobalThis, extend, isBuiltInDirective, NO, hasOwn, remove, def, isOn, isReservedProp, normalizeClass, stringifyStyle, normalizeStyle, isKnownSvgAttr, isBooleanAttr, isKnownHtmlAttr, includeBooleanAttr, isRenderableAttrValue, normalizeCssVarValue, getEscapedCssVarName, invokeArrayFns, isRegExp, toHandlerKey, camelize, capitalize, isObject, isSymbol, isGloballyAllowed, hyphenate, EMPTY_ARR, makeMap, toRawType, hasChanged, looseToNumber, isModelListener, toNumber } from "../../../../../@vue_shared@3.5.24/node_modules/@vue/shared/dist/shared.esm-bundler.js";
import { normalizeProps, toDisplayString } from "../../../../../@vue_shared@3.5.24/node_modules/@vue/shared/dist/shared.esm-bundler.js";
const stack = [];
